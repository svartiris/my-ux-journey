...
const CaseStudyExpanded = ({ study }: Props) => {
  ...
  return (
    <div className="mt-10 p-8 rounded-xl bg-muted/30 border border-border animate-fade-in-up">
      {/* Two-column layout: Left = Problem & Outcome, Right = Role & Process & Afterthought */}
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* RIGHT COLUMN */}
        <div className="space-y-6">
          {/* 2. My Role — single column since only 2 sub-items */}
          <div className="p-5 rounded-lg bg-background border border-border">
          ...
          {/* Screens below Research Process (right column) */}
          {hasScreens && (
            <div className="p-5 rounded-lg bg-background border border-border">
          ...
          {/* 5. Afterthought — aligned to start at same height as Outcome */}
          <div className="p-5 rounded-lg bg-background border border-border">
